...
public class KThread {
    ...
    //Despues de terminar de ejecutar, revisar si hay alguno en joinQueue para que se ejecute
    sleep();
    }
    ...
    public void join() {
       ...
       //Instancia actual es la que esta corriendo en el procesador
	     Lib.assertTrue(this != currentThread);
	     Machine.interrupt().disable();
        //si el thread no ha terminado y no esta en el procesador, no esta en currentthread
       if(status != statusFinished && this != currentThread){
         //Creamos una join tread queue para ingresar el thread
